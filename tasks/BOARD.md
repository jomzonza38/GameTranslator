...
|---|---|---|---|---|---|
| [T-0002](T-0002-game-window-closed-while-capturing.md) | Closing the game while translating must stop cleanly and tell the user | REVIEW | P1 | — | Cowork (review) + owner (AC-4, AC-5 manual) |
